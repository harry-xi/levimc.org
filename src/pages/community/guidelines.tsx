...
const CommunityGuidelines: NextPage = () => (
  <>
    <SEO
      ...
      keywords={["papermc", "levilamina", "minecraft", "community", "guidelines"]}
    ...
    >
      ...
      <p>
        We do this because creating an exhaustive list for all negative behavior
        we want to avoid is impossible and likely won&apos;t help anyways. The
        kinds of people who would engage in such a way in the first place
        probably aren&apos;t the people we want around at all.
        <br />
        <br />
      ...
      <ol className="list-decimal list-inside my-4 ml-4 space-y-2 py-1">
        <li>
          Using language or posting content that can reasonably be considered
          discriminatory.
        ...
        <li>
          Spamming or excessively sending messages, including repeating
          questions, resending links too frequently, or posting the same
          question to multiple channels.
          <ol className="list-alpha list-inside ml-6 space-y-2 py-1">
            <li>
              Spam bots and trolling users will be immediately banned without
              warning.
            </li>
            <li>
        ...
        <li>
          Trying to buy or sell services or hire developers. This is not a
          marketplace.
        </li>
        <li>
          Formatting usernames to be difficult to read, to impersonate others,
          to advertise, or to be inappropriate.
          <ol className="list-alpha list-inside ml-6 space-y-2 py-1">
            <li>
            ...
            <li>
              ...
              impossible to pronounce aren&apos;t very conducive of a good
              conversation environment. However, this does not apply to
              usernames in different languages and alphabets. There is a
              difference between having a username in Japanese and having only
              random symbols as your username.
            </li>
          </ol>
        </li>
        <li>
          Pinging server staff, moderators, or contributors without a valid
          reason.
          <ol className="list-alpha list-inside ml-6 space-y-2 py-1">
            <li>
        ...
        <li>
          Discussing politics or political controversy. We prohibit this in
    ...
    >
      ...
      <ul className="list-disc list-inside my-4 ml-4">
        ...
        <li>
          Ableist slurs or speech &mdash; there&apos;s confusion around this
